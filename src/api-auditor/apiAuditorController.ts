...
// import { ApiSpecification, ApiSpecificationEntityContent,ApiResponse,   } from "./apiSpecificationEntity";
...
//     const entityTypes : EntityProperties [] = [];
//     entityResponse.forEach(async (res) => {
...
//                 if (!lodash.isObject(value) ) {
//                     const entityTypeContent: EntityProperties = {};
